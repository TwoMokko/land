		...
		<article key={model.slug} className={styles.card} id={model.slug}>
			...
			<div className={styles.infoWrap}>
				<h3 className={styles.modelTitle}>
					{model.brand} <span>{model.name}</span>
				</h3>
				...
				<div className={styles.prices}>
					<div className={styles.price}>{formatPrice(model.price)} ₽</div>
					<div className={styles.oldPrice}>{formatPrice(model.recprice)} ₽</div>
				</div>
				...
				<div className={styles.btnWrap}>
					...
					<Button onClick={() => handleModal("order")} variant={"secondary"} withArrow>
