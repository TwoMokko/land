...
export function Social({ idSection }: { idSection: string }) {
	...
	const imageSrc = !isReady
		...
		: isMobile
			? "/images/social/social-bot-mob.png"
			: isLaptop
				? "/images/social/social-bot-tablet.png"
				: "/images/social/social-bot-desk.png";

	return (
		<section id={idSection} className={styles.socialSection}>
			<div className={styles.social}>
				...
				<div className={styles.list}>
					...
					<div className={styles.listItem}>
						<Link href={socialLinks.telegram} target="_blank" rel="noopener noreferrer">
							<FaTelegram size={40} />
						</Link>
						<span className={styles.listTitle}>400+</span>
						<p className={styles.listSubtitle}>
							фото и видео контента
							<br />о нашем Автомолле
						</p>
					</div>
					<div className={styles.listItem}>
						<Link
				...
				<div className={styles.inst}>
					<sup>*</sup>Instagram — проект Meta Platforms Inc., деятельность которой
					запрещена в России
				</div>
			</div>
